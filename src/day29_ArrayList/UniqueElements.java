...
public class UniqueElements {
    ...
    public static void main(String[] args) {
        ...
        for (Integer each : list) {
            ...
            int frequency1 = Collections.frequency(list, each ); // finds the frequency of each element
            if(frequency == 1){
                unique.add(each);
            }
        }
        ...
        ArrayList<Integer> unique3 = new ArrayList<>(list2); //add all the elements of list2
